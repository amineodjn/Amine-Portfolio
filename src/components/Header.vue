  ...
  <header class="header">
    ...
    <div class="wrapper">
      <nav class="header_nav">
        ...
        <a href="https://github.com/amineodjn" class="header_social" target="_blank" >
        ...
        <a href="https://www.linkedin.com/in/amine-oudjana/" class="header_social" target="_blank" >
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" aria-labelledby="socialLinkdIn" role="img">
            <title id="socialLinkdIn">Linkdin</title>
